...
<div class="divide-y-2 divide-teal-400">
    @hasanyrole('Administrador del sistema|vendedor|cliente')
        <div x-data="{ open: true }"
            ...
            <div @click="open = ! open" class="bg-teal-100 p-6 w-full flex justify-between items-center">
                <div class="flex items-center gap-2">
                    <i class="fa-solid fa-calendar-days pl-5 text-teal-600"></i>
                    <p class="ml-4 text-lg text-teal-600 leading-7 font-semibold">
                        Citas proximas:
                    </p>
                </div>
                <i class="fas fa-chevron-down fa-lg text-teal-600"></i>
            </div>
                            ...
                            <div class="grid lg:gap-x-12 lg:grid-cols-3">
                                <div class="mb-12 lg:mb-0">
                                    <div class="rounded-lg shadow-lg h-full block bg-white">
                                        ...
                                        <div class="flex justify-center">
                                            <div class="p-4 bg-teal-500 rounded-full shadow-lg inline-block -mt-8">
                                        ...
                                        --}}
                                        <div class="p-6">
                                            <h3 class="text-2xl font-bold text-teal-500 mb-4">10</h3>
                                            <h5 class="text-lg font-medium mb-4">Pendientes</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-12 lg:mb-0">
                                    <div class="rounded-lg shadow-lg h-full block bg-white">
                                        ...
                                        <div class="p-6">
                                            <h3 class="text-2xl font-bold text-teal-500 mb-4">10</h3>
                                            <h5 class="text-lg font-medium mb-4">Aceptados</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="rounded-lg shadow-lg h-full block bg-white">
                                        ...
                                        <div class="p-6">
                                            <h3 class="text-2xl font-bold text-teal-500 mb-4">10</h3>
                                            <h5 class="text-lg font-medium mb-4">Rechazados</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
